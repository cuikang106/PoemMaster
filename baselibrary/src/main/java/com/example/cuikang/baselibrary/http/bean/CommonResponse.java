...
public class CommonResponse {
    ...
    public CommonResponse(String responseString) {
        ...
        try {
             ...
             */
            resCode = root.getString("resCode");//如果没传回来，会报异常
            resMsg = root.optString("resMsg");//不会报异常

            JSONObject property = root.optJSONObject("property");//property是一个哈希表，需要用一个json进一步解析
            if (property != null) {
