package com.example.cuikang.baselibrary.http;
    ...
    protected void onPostExecute(String result) {
        if (rHandler != null) {
            if (!"".equals(result)) {
                ...
                if ("0".equals(response.getResCode())) { // 0意味着正确，其他code均为错误！
                    rHandler.success(response);     //这里调用ResponseHandler接口的success函数和fail函数！
                } else {
